...
|---|---:|---:|---:|---:|---:|
| PA baseline stress | 15.107 | -34.531 | 32.415 | -42.041 | — |
| PA baseline nominal | 12.095 | -40.405 | 32.886 | -48.280 | — |
| Basic DPD-GMP stress | 15.095 | -39.238 | 32.729 | -48.039 | -58.183 |
| Basic DPD-GMP nominal | 12.086 | -46.122 | 33.003 | -54.562 | -58.183 |
| Memory-expanded DPD-GMP | 12.086 | -46.234 | 33.007 | -54.498 | -60.035 |
| Peak-weighted DPD-GMP | 12.086 | -46.319 | 33.037 | -54.706 | -59.724 |
| Regularized DPD-GMP | 12.086 | -46.180 | 32.998 | -54.271 | -59.563 |
| Multi-power DPD-GMP | 12.088 | -44.770 | 32.990 | -52.534 | -55.607 |
...
|---|---:|---:|---:|---|
| Wi-Fi EVM | -40.405 dB | -46.122 dB | 5.717 dB | 是，EVM更负 |
| 双音IM3 | -48.280 dBc | -54.562 dBc | 6.281 dB | 是，IM3更负 |
| ACLR | 32.886 dB | 33.003 dB | 0.117 dB | 是，ACLR更高 |
...
|---|---:|---:|---:|---|
| Wi-Fi EVM | -39.238 dB | -46.122 dB | 6.883 dB | 是 |
| ACLR | 32.729 dB | 33.003 dB | 0.274 dB | 是 |

在15 dBm处，基础DPD仍把独立验证帧上的同功率PA baseline EVM从-34.531 dB改善到-39.238 dB，改善4.707 dB，说明该点可由当前受限结构稳定补偿。回到12 dBm后的额外改善证明的是功率回退收益，而不是15 dBm不可逆。
...
| Wi-Fi EVM | -46.122 dB | -46.234 dB | 0.112 dB | 小幅改善 |

本项预期是“更准确描述ILC标签”，不是保证射频指标同比例下降。标签NMSE改善1.852 dB，而独立帧EVM只改善0.112 dB，符合默认记忆较弱的测量事实，也说明继续增加结构的边际射频收益已经很小。
...
| Wi-Fi EVM | -46.319 dB | -46.180 dB | -0.139 dB | 允许的小幅代价 |
...
| 10/12/14 dBm最差ACLR | 32.890 dB | 32.862 dB | -0.028 dB | 是，退化未超过0.10 dB容限 |
| 10/12/14 dBm最差EVM | -41.769 dB | -40.737 dB | -1.031 dB | 跨功率EVM折中 |
| 12 dBm EVM | -46.180 dB | -44.770 dB | -1.410 dB | 单点性能折中 |

多功率模型改善了预先声明的最差标签NMSE；独立验证帧的最差ACLR下降0.028 dB，但仍满足“不退化超过0.10 dB”的预设容限。与此同时最差EVM和12 dBm单点EVM都退化。这不是“全面更好”，而是当前1/2/1权重下的明确折中。这说明下一步有两种选择：
